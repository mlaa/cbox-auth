...
/**
 * test lorem ipsum what on earth will i write here
 * who knows! hopefully it's long enough
 *
...
class CustomAuthenticationTest extends Base {
	 ...
	 * @covers CustomAuthentication::ajax_validate_preferred_username
	 *
	...
	public function provider_test_ajax_test_user() {
		// use string 'true' and 'false' to match json response
		return array(
			array( '999999', 'test', 'true' ),
			array( '999999', '', 'false' ),
			array( 'exampleuser', 'test', 'true' ),
			array( 'exampleuser', '', 'false' ),
		);
	}
	 ...
	 * @covers CustomAuthentication::ajax_test_user
	 *
