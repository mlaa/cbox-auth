...
class WebDriverDemo extends Sauce\Sausage\WebDriverTestCase
{
    ...
    protected $start_url = 'http://sinclair.mlacommons.org';
    ...
    {
        $this->assertEquals("MLA Commons", $this->title());
    }

    public function testLink()
    {
        $link = $this->byId('menu-item-243');
        $link->click();
        $this->assertContains("Groups", $this->title());
    }
